...
employeesRouter.post('/employees/add/:guid_user', employeesController.createEmployee);
...
employeesRouter.patch('/employees/update/:guid_employee/:guid_user', employeesController.updateEmployee);
