...
employeesRouter.post('/employees/add/:guid_user/:guid_projects', employeesController.createEmployee);
...
employeesRouter.patch('/employees/update/:guid_employee/:guid_user/:guid_projects', employeesController.updateEmployee);
